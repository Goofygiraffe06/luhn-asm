...
jmp_tbl:
        dd      detect_card_type.unknown
        dd      detect_card_type.unknown
        dd      detect_card_type.unknown
        dd      detect_card_type.check_amex
        dd      detect_card_type.visa
        dd      detect_card_type.check_mastercard
        dd      detect_card_type.check_discover
